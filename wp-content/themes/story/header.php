	...
	<header id="masthead" class="site-header" role="banner">
		<div id="header-inner">
			...
			<div class="site-branding">
				<h1 class="site-title <?php echo $story_class; ?>"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php echo $story_logo; ?></a>
                                <span class="site-description" style="color:white;">当你回想起部队生活，会很欣慰的告诉自己，我，曾“在路上”。</span>
                                </h1>
			</div>
